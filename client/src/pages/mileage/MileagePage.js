...
//   const [totalSpent, setTotalSpent] = useState(0); // 유저 스키마의 totalSpent 필드
...
//           setTotalSpent(userData.totalSpent || 0); // totalSpent 필드 사용
...
//           }}>
//           <Box sx={{flex: 1}}>
//             {/* MileageSummary에 totalSpent prop을 전달 */}
//             <MileageSummary totalMileage={totalMileage} totalSpent={totalSpent} />

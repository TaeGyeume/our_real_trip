  ...
  return (
    <SvgIcon>
      <svg
        ...
        height="16">
        <path
          d="M23 12c0 6.627-5.373 12-12 12S-1 18.627-1 12S3.373 0 12 0s12 5.373 12 12Z"
          fill="#03C75A"
        />
        <path
          d="M10 15.5V8.5H7.5v7H10Zm6.5 0V8.5H14v7h2.5ZM13 2h-2v4h2V2ZM7 2H5v4h2V2Zm-1 8v1h4V10H6Z"
          fill="#fff"
        />
      </svg>
    </SvgIcon>
  ...
  return (
    <SvgIcon>
      <svg
        ...
        />
        <path
          d="M16.125 9.5H7.875C6.8375 9.5 6 10.3375 6 11.375v1.25c0 1.0375.8375 1.875 1.875 1.875h8.25c1.0375 0 1.875-.8375 1.875-1.875v-1.25c0-1.0375-.8375-1.875-1.875-1.875Zm0 3.125H7.875V11.375h8.25v1.25Z"
          fill="#fff"
        />
      </svg>
    </SvgIcon>
